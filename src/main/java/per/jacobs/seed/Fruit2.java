...
import per.jacobs.see.driverFactory.SeedDriverFactory;
...
public class Fruit2 {
	...
	private static Logger logger = LogManager.getLogger(Fruit2	.class.getName());
	
	public Fruit2(String browserType) {
		...
		driver = factory.getDriver(browserType);
